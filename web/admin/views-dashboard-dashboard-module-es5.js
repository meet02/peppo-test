(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-dashboard-dashboard-module"], {
    ...
    function l70X(module, __webpack_exports__, __webpack_require__) {
      ...
      var _constants_error_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var DashboardComponent = /*#__PURE__*/function () {
        function DashboardComponent(httpService, toaster) {
          var _this2 = this;
          ...
          this.totalCollection = 1000;
          this.freeCollection = 500;
          this.premiumCollection = 500; // lineChart1
          ...
          this.getData = function () {
            _this2.httpService.postMethod("".concat(_config__WEBPACK_IMPORTED_MODULE_6__["config"].BASE_URL, "collection/count"), {}).subscribe(function (data) {
              if (data.data) {
                _this2.totalCollection = data.data.totalCount;
                _this2.freeCollection = data.data.feeCount;
                _this2.premiumCollection = data.data.premiumCount;
              } else {
                _this2.toaster.open({
                  text: _constants_error_constants__WEBPACK_IMPORTED_MODULE_7__["ErrorConstants"].INTERNAL_SERVER_ERROR,
                  caption: 'Error',
                  type: "danger"
                });
              }
        ...
        _createClass(DashboardComponent, [{
          ...
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getData(); // generate random values for mainChart
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_http_service__WEBPACK_IMPORTED_MODULE_5__["HttpService"], ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_8__["Toaster"]])], DashboardComponent);
      /***/
    }
  }]);
})();
