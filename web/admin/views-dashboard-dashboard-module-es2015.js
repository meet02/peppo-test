...
/* harmony import */ var _constants_error_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../constants/error-constants */ "Q4XJ");
...
let DashboardComponent = class DashboardComponent {
    constructor(httpService, toaster) {
        ...
        this.getData = () => {
            this.httpService.postMethod(`${_config__WEBPACK_IMPORTED_MODULE_6__["config"].BASE_URL}collection/count`, {}).subscribe((data) => {
                if (data.data) {
                    this.totalCollection = data.data.totalCount;
                    this.freeCollection = data.data.feeCount;
                    this.premiumCollection = data.data.premiumCount;
                }
                else {
                    this.toaster.open({
...
DashboardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_http_service__WEBPACK_IMPORTED_MODULE_5__["HttpService"], ngx_toast_notifications__WEBPACK_IMPORTED_MODULE_8__["Toaster"]])
], DashboardComponent);
